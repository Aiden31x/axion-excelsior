      ...
      <section className="bg-gradient-to-br from-purple-50 via-purple-100 to-blue-50 py-20 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            {t.contact.title} <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">{t.contact.us}</span>
          </h1>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl p-8 lg:p-12 border border-purple-200/30 relative overflow-hidden">
            ...
            <div className="text-center mb-8 relative z-10">
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                {t.contact.requestDemo} <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">{t.contact.demo}</span>
              </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-gray-900 mb-4">
              {t.contact.getInTouch} <span className="bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">{t.contact.touch}</span>
            </h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-purple-200/30 text-center relative overflow-hidden hover-lift transition-all duration-300">
              ...
              <h4 className="text-xl font-semibold text-gray-900 mb-2 relative z-10">{t.contact.visitUs}</h4>
              <p className="text-gray-700 relative z-10">
                {t.contact.madeInCanada}<br />
                <span className="text-sm">{t.contact.forCanadianInstitutions}</span>
              </p>
            </div>
          </div>
        </div>
